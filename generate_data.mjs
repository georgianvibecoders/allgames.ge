...
ids.forEach((info, index) => {
  ...
  if (info.appId) {
    imageUrl = 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/' + info.appId + '/library_600x900.jpg';
...
const out = "import { Sword, Map as MapIcon, Target, Car, Users, Ghost, MoreHorizontal } from 'lucide-react';" + Object.keys(ALL_GAMES).length + "\\n" +
\`
...
export const POPULAR_GAMES = \${JSON.stringify(POPULAR_GAMES, null, 2)};

export const ALL_GAMES = \${JSON.stringify(ALL_GAMES, null, 2)};
\`;
